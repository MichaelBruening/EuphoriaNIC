 ...
 */
$hometext = elgg_get_plugin_setting("hometext","euphorianic");
if (!$hometext) {
    $hometext = "<h1>Edit this home text in your admin panel.</h1>";
}
$nivo_theme = elgg_get_plugin_setting("nivo_theme","euphorianic");
if (!$nivo_theme) {
    $nivo_theme = "theme-default";
}
$slide1 = elgg_get_plugin_setting("slide1","euphorianic");
if (!$slide1) {
    $slide1 = elgg_get_site_url()."mod/euphorianic/graphics/slide1.png";
}
$slide2 = elgg_get_plugin_setting("slide2","euphorianic");
if (!$slide2) {
    $slide2 = elgg_get_site_url()."mod/euphorianic/graphics/slide2.png";
}
$slide3 = elgg_get_plugin_setting("slide3","euphorianic");
if (!$slide3) {
    $slide3 = elgg_get_site_url()."mod/euphorianic/graphics/slide3.png";
}
$slide4 = elgg_get_plugin_setting("slide4","euphorianic");
if (!$slide4) {
